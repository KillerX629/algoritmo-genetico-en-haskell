...
/* package algenHaskell-0.1.0.0 */
#ifndef VERSION_algenHaskell
#define VERSION_algenHaskell "0.1.0.0"
#endif /* VERSION_algenHaskell */
#ifndef MIN_VERSION_algenHaskell
#define MIN_VERSION_algenHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_algenHaskell */
...
#define CURRENT_COMPONENT_ID "algenHaskell-0.1.0.0-inplace-algenHaskell"
